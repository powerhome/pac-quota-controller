...
const serviceAccountName = "pac-quota-controller-controller-manager"

// metricsServiceName is the name of the metrics service of the project
const metricsServiceName = "pac-quota-controller-controller-manager-metrics-service"

// metricsRoleBindingName is the name of the RBAC that will be created to allow get the metrics data
const metricsRoleBindingName = "pac-quota-controller-metrics-binding"
...
var _ = Describe("ClusterResourceQuota Controller", Ordered, func() {
	...
	Context("Manager", func() {
		...
		It("should ensure the metrics endpoint is serving metrics", func() {
			...
			// First check if the ClusterRoleBinding already exists
			checkCmd := exec.Command("kubectl", "get", "clusterrolebinding", metricsRoleBindingName, "--ignore-not-found")
			output, _ := utils.Run(checkCmd)

			// Clean up any existing binding to avoid conflicts
			if output != "" {
			...
			cmd := exec.Command("kubectl", "create", "clusterrolebinding", metricsRoleBindingName,
				"--clusterrole=pac-quota-controller-metrics-reader",
			...
			verifyMetricsServerStarted := func(g Gomega) {
				...
				// Check for JSON formatted logs (our zap configuration)
